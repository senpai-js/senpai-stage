import { awayDown, awayUp, common, hoverDown, hoverUp } from "./commonSetupTextInput";
...
describe("Sprite hover property", () => {
  ...
  test("point that never hovers or moves", () => {
    ...
    expect(sprites.sprite.hover).toBeFalsy();
  });
  ...
  test("point that goes down over sprite, then moves away from sprite while still down", () => {
